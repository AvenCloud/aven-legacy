...
class MyProjectList extends React.Component {
  render() {
    ...
    return ( <
      ...
      ARowSection title = "Recent Projects" > {
        Object.keys(projects).map(projectName => {
          return ( <
            ...
            title = {
              `${projectName} - ${projects[projectName].isPublic ? "Public" : "Private"}`
            }
            onPress = {
              () => {
      ...
      /ARowSection> <
      AButton title = "See all projects"
      onPress = {
        () => {}
      }
      style = "secondary" /
...
class LoggedInHome extends React.Component {
    render() {
        ...
        return ( <
          AGenericScreen header = { <
            ...
            render = {
              ...
              <
              AButton title = "Terms and Privacy"
              onPress = {
                () => {}
              }
              style = "small" / >
              <
              AButton title = "About Aven"
              onPress = {
                () => {}
              }
              style = "small" / >
              ...
              Loaders.Session render = {
                session => {
                  if (session) {
                    ...
                    return <LoggedOutHome navigation = {
                      navigation
                    }
                    />;
                  }
        ...
        class PlaintextView extends React.Component {
          ...
          kbWillShow = event => {
            this.setState({
              kbInset: event.endCoordinates.height
            });
          };
                ...
                class ARowSection extends React.Component {
                    ...
                    class AButton extends React.Component {
                      render() {
                        ...
                        return ( <
                          ...
                          onPress = {
                            this.props.disabled === true ? null : this.props.onPress
                          } >
                          <
                          Text style = {
                            {
                    ...
                    class NewProjectScreen extends React.Component {
                        render() {
                          ...
                          return ( <
                            FormScreen header = { < AHeader title = "New Project"
                              navigation = {
                                navigation
                              }
                              />}
                        ...
                        class LoginScreen extends React.Component {
                            ...
                            render() {
                              ...
                              return ( <
                                FormScreen header = { < AHeader title = "Login"
                                  navigation = {
                                    this.props.navigation
                                  }
                                  />}
