...
return(
_react2.default.createElement(SmallFormPage,{__source:{fileName:_jsxFileName,lineNumber:92}},
_react2.default.createElement("form",{method:"post",__source:{fileName:_jsxFileName,lineNumber:93}},
_react2.default.createElement("h1",{style:{position:"relative",bottom:15},__source:{fileName:_jsxFileName,lineNumber:94}},
opts.heading),

opts.subheadingText&&
_react2.default.createElement("p",{style:{marginTop:-10,marginBottom:30},__source:{fileName:_jsxFileName,lineNumber:98}},
opts.subheadingText),

opts.inputs.map(function(inputConfig,inputIndex){
if(inputConfig.type==="email-phone-signup"){
return(
_react2.default.createElement(EmailPhoneThing,_extends({key:"email-phone-signup"},inputConfig,{__source:{fileName:_jsxFileName,lineNumber:104}})));

}
return(
_react2.default.createElement("div",{className:"form-group",key:inputConfig.name,__source:{fileName:_jsxFileName,lineNumber:108}},
inputConfig.rightLabel&&
_react2.default.createElement("span",{className:"control-label-right",__source:{fileName:_jsxFileName,lineNumber:110}},
inputConfig.rightLabel(values)),

_react2.default.createElement("label",{className:"control-label","for":inputConfig.name,__source:{fileName:_jsxFileName,lineNumber:113}},
inputConfig.label),
...
type:inputConfig.type,__source:{fileName:_jsxFileName,lineNumber:116}})));
...
validationError&&
_react2.default.createElement("div",{className:"alert alert-dismissible alert-danger",__source:{fileName:_jsxFileName,lineNumber:128}},
_react2.default.createElement("button",{type:"button",className:"close","data-dismiss":"alert",__source:{fileName:_jsxFileName,lineNumber:129}},"\xD7"),


_react2.default.createElement("strong",{__source:{fileName:_jsxFileName,lineNumber:132}},"Whoops!")," ",validationError),


_react2.default.createElement("div",{
className:"form-group",
style:{position:"relative",top:10},__source:{fileName:_jsxFileName,lineNumber:135}},
...
display:"flex",
alignItems:"center",
flexDirection:"column"},__source:{fileName:_jsxFileName,lineNumber:139}},


_react2.default.createElement("button",{className:"btn btn-primary btn-lg",__source:{fileName:_jsxFileName,lineNumber:147}},
