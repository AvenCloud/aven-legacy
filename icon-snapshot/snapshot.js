...
app.get('/', (req, res) => {
  ...
  res.send( // this is embarrassing:
    ...
    'text-align: center;vertical-align: middle;position: absolute;padding: 0;margin: 0;background: '+bgColor+';left: 0;right: 0;top: 0;bottom: 0;">'+
    '<i class="fa fa-'+iconName+'" aria-hidden="true" style="color: '+iconColor+'; font-size: '+iconSize+'px; margin-top: '+
    ((viewportHeight/2)-(iconSize/2))+'px;"></i></body></html>'
  );
});
