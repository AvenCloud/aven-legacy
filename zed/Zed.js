...
type ZObjectDef = { __zType: "ZObject", items: ZMap };
type ZObjectTypeDef = { __zType: "ZObjectType", type: ZData, items: ZMap };
type ZOrDef = { __zType: "ZOr", options: ZSet };
type ZArrayDef = { __zType: "ZArray", items: ZSet };
type ZFilledArrayDef = { __zType: "ZFilledArray", item: ZData };
...
export function ZObject(items: ZMap): ZObjectDef {
  return { __zType: "ZObject", items };
}

export function ZObjectType(type: ZData, items: ZMap): ZObjectTypeDef {
  return { __zType: "ZObjectType", type, items };
}

export function ZFilledArray(item: ZData): ZFilledArrayDef {
  return { __zType: "ZFilledArray", item };
}

export function ZArray(items: ZSet): ZArrayDef {
  return { __zType: "ZArray", items };
}
...
export function ZEquals(a: ZData, b: ZData): ZEquals {
  return { __zType: "ZEquals", a, b };
}

export function ZSum(a: ZData, b: ZData): ZSum {
  return { __zType: "ZSum", a, b };
}

export function ZOr(...options: ZSet): ZOrDef {
...
export class ZStore {
  ...
  set(named: string, newDoc: ZData) {
    this.mutate(ZAddress(named), newDoc);
    return ZAddress(named);
  }
  compute(doc: ZData) {
    if (doc == null) {
      return {};
